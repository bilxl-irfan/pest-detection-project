...
private:
    ...
    size_t   ngpus;
    Tfloat** bufs;
    Tfloat** dbufs; // Store a device-side version
...
public:
        ...
        , ngpus(ngpus_)
    {
        ...
        bufs = (Tfloat**)malloc(sizeof(Tfloat*) * ngpus);
        ...
        HIP_CHECK(hipSetDevice(0));
        HIP_CHECK(hipMalloc(&dbufs, sizeof(Tfloat*) * ngpus));
        HIP_CHECK(hipMemcpy(dbufs, bufs, sizeof(Tfloat*) * ngpus, hipMemcpyHostToDevice));
    }
